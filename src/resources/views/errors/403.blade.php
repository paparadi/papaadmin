...
<head>
  ...
  <link rel=You are not allowed to access this resource/css/vendor.bundle.addons.css')}}">
  <!-- endinject -->
  <!-- inject:css -->
          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>SORRY!</h2>
                <h3 class="font-weight-light">You are not allowed to access this resource</h3>
              </div>
            </div>
            <div class="row mt-5">
